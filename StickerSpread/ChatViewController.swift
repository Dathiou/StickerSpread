...
class ChatViewController: JSQMessagesViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.senderId = PFUser.currentUser()?.username //backendless.userService.currentUser.objectId
        self.senderDisplayName = PFUser.currentUser()?.username //backendless.userService.currentUser.name
